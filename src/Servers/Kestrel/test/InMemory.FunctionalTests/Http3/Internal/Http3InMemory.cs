...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Tests
{
    internal class Http3InMemory
    {
        ...
        public Http3InMemory(ServiceContext serviceContext, ITimeoutHandler timeoutHandler)
        {
            ...
            _serviceContext.SystemClock = _mockSystemClock;
        ...
        internal readonly ITimeoutControl _timeoutControl;
        ...
        internal async Task WaitForConnectionErrorAsync<TException>(bool ignoreNonGoAwayFrames, long? expectedLastStreamId, Http3ErrorCode expectedErrorCode, Action matchExpectedErrorMessage = null)
            where TException : Exception
        {
            ...
            AssertConnectionError<TException>(expectedErrorCode, matchExpectedErrorMessage);
        ...
        internal void AssertConnectionError<TException>(Http3ErrorCode expectedErrorCode, Action matchExpectedErrorMessage = null) where TException : Exception
        {
            ...
            matchExpectedErrorMessage?.Invoke();
        ...
        private static void AssertFrameType(Http3FrameType actual, Http3FrameType expected)
        {
            if (actual != expected)
            {
        ...
        internal class Http3StreamBase : IProtocolErrorCodeFeature
        {
            ...
            internal async Task WaitForStreamErrorAsync(Http3ErrorCode protocolError, Action matchExpectedErrorMessage)
            {
